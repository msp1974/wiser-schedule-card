...
export const fetchScheduleById = (hass: HomeAssistant,  hub: string, schedule_type: string, id: number): Promise<Schedule> =>
    hass.callWS({
...
export const assignSchedule = (hass: HomeAssistant, hub: string, schedule_type: string, schedule_id: number, id: string, remove = false): Promise<boolean> =>
    hass.callWS({
...
export const createSchedule = (hass: HomeAssistant, hub: string, schedule_type: string, name: string): Promise<boolean> =>
    hass.callWS({
...
export const deleteSchedule = (hass: HomeAssistant, hub: string, schedule_type: string, schedule_id: number): Promise<boolean> =>
    hass.callWS({
...
export const saveSchedule = (hass: HomeAssistant, hub: string, schedule_type: string, schedule_id: number, schedule: Schedule): Promise<boolean> =>
    hass.callWS({
...
export const copySchedule = (hass: HomeAssistant, hub: string, schedule_type: string, from_schedule_id: number, to_schedule_id: number): Promise<boolean> =>
    hass.callWS({
